...
impl ExplorerRandomnessBindingEvidence {
    pub fn to_json(&self) -> String {
        format!(
            ...
            self.validator_vrf_registered_key_count,
            self.validator_vrf_reveal_count,
            self.validator_vrf_production_reveal_count,
            self.validator_vrf_legacy_reveal_count,
        ...
        let randomness = ExplorerRandomnessBindingEvidence {
            ...
            drand_round_mapping:
                "local_finalized_height_to_beacon_round_v1:round=receipt_submission_finalized_beacon_round"
                    .to_owned(),
            vrf_construction:
                "validator_vrf_ed25519_v1:output=H(ed25519_signature(seed_input));legacy_unkeyed_local_fallback"
                    .to_owned(),
            ...
            validator_vrf_registered_key_count: 2,
            validator_vrf_reveal_count: 4,
            validator_vrf_production_reveal_count: 3,
            validator_vrf_legacy_reveal_count: 1,
