...
pub use wire::{
    ...
    decode_receipt_payload, decode_tensor_payload, decode_trace_bisection_round_payload,
    decode_trace_opening_payload, decode_validator_audit_report_payload,
    ...
    encode_trace_bisection_round_payload, encode_trace_opening_payload,
