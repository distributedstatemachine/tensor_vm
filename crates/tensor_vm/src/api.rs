...
pub enum P2pMessage {
    ...
    NewTraceBisectionExpectationPayload {
        receipt_id: Hash,
        trace_root: Hash,
        challenger: Address,
        responder: Address,
...
pub const PUBLIC_EVIDENCE_CLI_COMMANDS: &[&str] = &[
    ...
    "tvmd public evidence record summary --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --record-root <hex> --record-count <n>",
    "tvmd public evidence record artifact --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --artifact-uri <uri> --record-root <hex> --record-count <n>",
    "tvmd public evidence record artifact-roots --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --artifact-uri <uri> --record-roots <comma-separated-roots>",
    "tvmd public evidence record artifact-file --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --artifact-uri <uri> --record-file <path>",
    "tvmd public evidence record summary-roots --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --record-roots <comma-separated-roots>",
    "tvmd public evidence record summary-file --kind <block-history|finality-history|network-runtime|randomness-beacon|data-availability|invalid-work|reward-settlement|detection-measurement|validator-vrf-lifecycle> --bundle-id <hex> --manifest-signer <address-hex> --record-file <path>",
];
