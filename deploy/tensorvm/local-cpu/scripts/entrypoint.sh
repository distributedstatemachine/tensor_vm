...
LOCAL_CPU_COMMITTEE_SYNTHETIC_JOBS="${TENSORVM_LOCAL_CPU_COMMITTEE_SYNTHETIC_JOBS:-false}"
...

{
  ...
  echo "local_cpu_committee_synthetic_jobs=$LOCAL_CPU_COMMITTEE_SYNTHETIC_JOBS"
