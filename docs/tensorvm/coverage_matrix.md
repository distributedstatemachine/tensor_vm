...
that otherwise complete full-spec public evidence remains non-full-spec unless
`validator_vrf_lifecycle_records` exactly covers checked receipts.
...
counts and boolean CUDA miner/graph, VRF lifecycle, and deployed detection evidence gates.
