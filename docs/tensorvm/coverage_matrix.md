...
multi-output expected tensors for exact quantize scale output and dynamic-output `split`, Tier-A
matrix-contraction `einsum`, field-order comparison, selection, and clamp
