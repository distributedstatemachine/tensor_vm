...
producer, and `validator-00` plus delayed `validator-01` to be validator block proposers as reported by
readiness and role status, requires live role-loop counters, the `local_cpu` chain
