...
- Active feature: Iteration 171 in progress: Trace-Bisection Challenger Expected Roots.
...
- Next action: enforce challenger-signed expected midpoint roots before responder rounds can advance
  trace-bisection state, then validate and commit the feature.
