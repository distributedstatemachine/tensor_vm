...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 45 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 45 coverage could not
