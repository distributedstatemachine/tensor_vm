...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 64 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 64 coverage could not
