...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 52 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 52 coverage could not
