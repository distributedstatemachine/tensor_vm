...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 66 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 66 coverage could not
