...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 48 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 48 coverage could not
