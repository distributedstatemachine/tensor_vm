...
Latest attempted run: June 20, 2026 from the workspace root after Iteration 22 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 22 coverage could not
