...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 47 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 47 coverage could not
