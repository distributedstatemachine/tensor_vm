...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 42 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 42 coverage could not
