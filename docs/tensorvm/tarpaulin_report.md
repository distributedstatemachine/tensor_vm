...
Latest attempted run: June 20, 2026 from the workspace root during Iteration 44 with:
...
This environment does not currently have `cargo-tarpaulin` installed, so Iteration 44 coverage could not
